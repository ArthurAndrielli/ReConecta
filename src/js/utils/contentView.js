...
export function fallbackPicture(message = 'Ilustração indisponível') {
  ...
  return `<span class="object-picture object-picture-fallback"><svg viewBox="0 0 96 96" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${safe}" focusable="false"><title>${safe}</title><g fill="#B9ECDF" stroke="var(--color-illustration-outline)" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><rect x="15" y="17" width="66" height="62" rx="18"/><path fill="#FFFDF6" d="M31 36h34v25H31z"/><circle fill="#FFF08A" cx="41" cy="45" r="5"/><path fill="none" d="m33 58 10-9 8 7 7-6 7 8"/></g></svg><span>${safe}</span></span>`;
}
